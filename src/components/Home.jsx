...
function Home() {
  return (
    <>
      <div className="bg-body-background h-screen px-6 pt-6 lg:px-8 flex">
        <div className="text-center mx-auto max-w-2xl py-32 sm:py-30 lg:py-56">
          ...
          <p className="font-sans mt-6 text-lg leading-8 text-gray-800">
            ...
            friendly and effective SPAs with a keen eye for detail and a passion
            for learning.
          </p>
        ...
        <div className="flex-col text-center w-3/12 mx-auto max-w-2xl py-32 sm:py-30 lg:py-56">
          <p>Avatar</p>

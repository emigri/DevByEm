...
import img from "../assets/Emi-avatar.webp";
        ...
        <div className="w-full md:w-2/3 flex items-center md:px-24 px-4">
          <div className="text-center mx-auto">
            ...
            <p className="font-sans mt-6 text-lg leading-8 text-gray-800">
              I’m a Bristol-based web developer specialised in building user
              friendly and effective SPAs with a keen eye for detail and a
        ...
        <div className="w-full md:w-1/3 flex items-center">
          <div className="flex-col mx-auto ">
            <div className="flex justify-center">
              <img src={img} className="rounded-full drop-shadow-2xl w-3/4" />
            </div>
            <div className="w-full flex justify-center ">
              <div className="flex justify-around bg-rose-100 drop-shadow-xl p-3 rounded-lg m-6 w-1/2">
